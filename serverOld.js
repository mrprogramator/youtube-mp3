...
app.post('/music', function(req, res) {
  ...
  dl.on('exit', function (code) {
    ...
    var xx = child_process.spawn("./youtube-dl", ['--ffmpeg-location','./ffmpeg','-o',"'%((title)s.%(ext)s'",'--extract-audio','--audio-format','mp3','--max-downloads','1','-c','--default-search','ytsearch',url]);
